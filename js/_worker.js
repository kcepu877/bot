...
{ text: '🇨🇻 CV', callback_data: '/getrandomCV' },
  ...
  [
{ text: '🇰🇾 KY', callback_data: '/getrandomKY' },
{ text: '🇨🇫 CF', callback_data: '/getrandomCF' },
{ text: '🇹🇩 TD', callback_data: '/getrandomTD' },
{ text: '🇨🇱 CL', callback_data: '/getrandomCL' },
{ text: '🇨🇳 CN', callback_data: '/getrandomCN' },
],
  [
{ text: '🇨🇽 CX', callback_data: '/getrandomCX' },
{ text: '🇨🇨 CC', callback_data: '/getrandomCC' },
{ text: '🇨🇴 CO', callback_data: '/getrandomCO' },
{ text: '🇰🇲 KM', callback_data: '/getrandomKM' },
{ text: '🇨🇩 CD', callback_data: '/getrandomCD' },
],
  [
{ text: '🇬🇬 GG', callback_data: '/getrandomGG' },
{ text: '🇬🇳 GN', callback_data: '/getrandomGN' },
{ text: '🇬🇫 GF', callback_data: '/getrandomGF' },
{ text: '🇬🇮 GI', callback_data: '/getrandomGI' },
{ text: '🇬🇷 GR', callback_data: '/getrandomGR' },
],
  [
{ text: '🇬🇱 GL', callback_data: '/getrandomGL' },
{ text: '🇬🇩 GD', callback_data: '/getrandomGD' },
{ text: '🇬🇵 GP', callback_data: '/getrandomGP' },
{ text: '🇬🇺 GU', callback_data: '/getrandomGU' },
{ text: '🇬🇹 GT', callback_data: '/getrandomGT' },
],
  [
{ text: '🇬🇬 GN', callback_data: '/getrandomGN' },
{ text: '🇬🇶 GQ', callback_data: '/getrandomGQ' },
{ text: '🇪🇬 EG', callback_data: '/getrandomEG' },
{ text: '🇸🇻 SV', callback_data: '/getrandomSV' },
{ text: '🇬🇶 GQ', callback_data: '/getrandomGQ' },
],
  [
{ text: '🇪🇷 ER', callback_data: '/getrandomER' },
{ text: '🇪🇪 EE', callback_data: '/getrandomEE' },
{ text: '🇪🇹 ET', callback_data: '/getrandomET' },
{ text: '🇫🇰 FK', callback_data: '/getrandomFK' },
{ text: '🇫🇴 FO', callback_data: '/getrandomFO' },
],
  [
{ text: '🇫🇯 FJ', callback_data: '/getrandomFJ' },
{ text: '🇫🇮 FI', callback_data: '/getrandomFI' },
{ text: '🇫🇷 FR', callback_data: '/getrandomFR' },
{ text: '🇬🇦 GA', callback_data: '/getrandomGA' },
{ text: '🇬🇪 GE', callback_data: '/getrandomGE' },
],
  [
{ text: '🇩🇪 DE', callback_data: '/getrandomDE' },
{ text: '🇬🇭 GH', callback_data: '/getrandomGH' },
{ text: '🇬🇮 GI', callback_data: '/getrandomGI' },
{ text: '🇬🇷 GR', callback_data: '/getrandomGR' },
{ text: '🇬🇱 GL', callback_data: '/getrandomGL' },
],
...
{ text: '🇬🇶 GQ', callback_data: '/getrandomGQ' },
{ text: '🇬🇪 GE', callback_data: '/getrandomGE' },
{ text: '🇭🇹 HT', callback_data: '/getrandomHT' },
{ text: '🇭🇳 HN', callback_data: '/getrandomHN' },
],
  [
...
{ text: '🇮🇶 IQ', callback_data: '/getrandomIQ' },
{ text: '🇮🇪 IE', callback_data: '/getrandomIE' },
{ text: '🇮🇱 IL', callback_data: '/getrandomIL' },
{ text: '🇮🇹 IT', callback_data: '/getrandomIT' },
],
  [
{ text: '🇯🇲 JM', callback_data: '/getrandomJM' },
{ text: '🇯🇵 JP', callback_data: '/getrandomJP' },
{ text: '🇯🇴 JO', callback_data: '/getrandomJO' },
{ text: '🇰🇿 KZ', callback_data: '/getrandomKZ' },
{ text: '🇰🇪 KE', callback_data: '/getrandomKE' },
],
  [
{ text: '🇰🇮 KI', callback_data: '/getrandomKI' },
{ text: '🇰🇵 KP', callback_data: '/getrandomKP' },
{ text: '🇰🇷 KR', callback_data: '/getrandomKR' },
{ text: '🇰🇼 KW', callback_data: '/getrandomKW' },
{ text: '🇱🇦 LA', callback_data: '/getrandomLA' },
],
  [
{ text: '🇱🇧 LB', callback_data: '/getrandomLB' },
{ text: '🇱🇸 LS', callback_data: '/getrandomLS' },
{ text: '🇱🇷 LR', callback_data: '/getrandomLR' },
{ text: '🇱🇾 LY', callback_data: '/getrandomLY' },
{ text: '🇱🇹 LT', callback_data: '/getrandomLT' },
],
  [
{ text: '🇱🇺 LU', callback_data: '/getrandomLU' },
{ text: '🇲🇴 MO', callback_data: '/getrandomMO' },
{ text: '🇲🇬 MG', callback_data: '/getrandomMG' },
{ text: '🇲🇼 MW', callback_data: '/getrandomMW' },
{ text: '🇲🇾 MY', callback_data: '/getrandomMY' },
],
  [
{ text: '🇲🇻 MV', callback_data: '/getrandomMV' },
{ text: '🇲🇱 ML', callback_data: '/getrandomML' },
{ text: '🇲🇹 MT', callback_data: '/getrandomMT' },
{ text: '🇲🇭 MH', callback_data: '/getrandomMH' },
{ text: '🇲🇶 MQ', callback_data: '/getrandomMQ' },
],
  [
{ text: '🇲🇷 MR', callback_data: '/getrandomMR' },
{ text: '🇲🇺 MU', callback_data: '/getrandomMU' },
{ text: '🇾🇹 YT', callback_data: '/getrandomYT' },
{ text: '🇲🇽 MX', callback_data: '/getrandomMX' },
{ text: '🇫🇲 FM', callback_data: '/getrandomFM' },
],
  [
{ text: '🇲🇩 MD', callback_data: '/getrandomMD' },
{ text: '🇲🇨 MC', callback_data: '/getrandomMC' },
{ text: '🇲🇳 MN', callback_data: '/getrandomMN' },
{ text: '🇲🇪 ME', callback_data: '/getrandomME' },
{ text: '🇲🇸 MS', callback_data: '/getrandomMS' },
],
  [
{ text: '🇲🇦 MA', callback_data: '/getrandomMA' },
{ text: '🇲🇿 MZ', callback_data: '/getrandomMZ' },
{ text: '🇲🇲 MM', callback_data: '/getrandomMM' },
{ text: '🇳🇦 NA', callback_data: '/getrandomNA' },
{ text: '🇳🇷 NR', callback_data: '/getrandomNR' },
],
  [
{ text: '🇳🇵 NP', callback_data: '/getrandomNP' },
{ text: '🇳🇱 NL', callback_data: '/getrandomNL' },
{ text: '🇳🇨 NC', callback_data: '/getrandomNC' },
{ text: '🇳🇿 NZ', callback_data: '/getrandomNZ' },
{ text: '🇳🇮 NI', callback_data: '/getrandomNI' },
],
  [
{ text: '🇳🇪 NE', callback_data: '/getrandomNE' },
{ text: '🇳🇬 NG', callback_data: '/getrandomNG' },
{ text: '🇳🇺 NU', callback_data: '/getrandomNU' },
{ text: '🇳🇫 NF', callback_data: '/getrandomNF' },
{ text: '🇲🇵 MP', callback_data: '/getrandomMP' },
],
  [
{ text: '🇳🇴 NO', callback_data: '/getrandomNO' },
{ text: '🇴🇲 OM', callback_data: '/getrandomOM' },
{ text: '🇵🇰 PK', callback_data: '/getrandomPK' },
{ text: '🇵🇼 PW', callback_data: '/getrandomPW' },
{ text: '🇵🇦 PA', callback_data: '/getrandomPA' },
],
  [
{ text: '🇵🇬 PG', callback_data: '/getrandomPG' },
{ text: '🇵🇾 PY', callback_data: '/getrandomPY' },
{ text: '🇵🇪 PE', callback_data: '/getrandomPE' },
{ text: '🇵🇭 PH', callback_data: '/getrandomPH' },
{ text: '🇵🇳 PN', callback_data: '/getrandomPN' },
],
  [
...
{ text: '🇷🇼 RW', callback_data: '/getrandomRW' },
{ text: '🇬🇦 GA', callback_data: '/getrandomGA' },
{ text: '🇬🇧 GB', callback_data: '/getrandomGB' },
{ text: '🇺🇸 US', callback_data: '/getrandomUS' },
],
  [
{ text: '🇺🇾 UY', callback_data: '/getrandomUY' },
{ text: '🇺🇿 UZ', callback_data: '/getrandomUZ' },
{ text: '🇻🇺 VU', callback_data: '/getrandomVU' },
{ text: '🇻🇪 VE', callback_data: '/getrandomVE' },
{ text: '🇻🇳 VN', callback_data: '/getrandomVN' },
],
  [
{ text: '🇼🇫 WF', callback_data: '/getrandomWF' },
{ text: '🇾🇪 YE', callback_data: '/getrandomYE' },
{ text: '🇿🇲 ZM', callback_data: '/getrandomZM' },
{ text: '🇿🇼 ZW', callback_data: '/getrandomZW' },
  ],
